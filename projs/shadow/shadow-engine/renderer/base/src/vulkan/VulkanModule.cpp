                                            ...
                                            frame,
                                            {
                                                ...
                                                [this, frame](const VkCommandBuffer &commands) {
                                                    if (!editorEnabled) {
                                                        renderingGeometry =
                                                            true;
                                                        SH::ShadowApplication::Get().GetEventBus().fire(SH::Events::Render(const_cast<VkCommandBuffer&>(commands), frame));

                                                        SH::ShadowApplication::Get().GetEventBus().fire(SH::Events::PostRender(const_cast<VkCommandBuffer&>(commands), frame));
                                                        renderingGeometry =
                                                            false;
                                                    }
                                                },
